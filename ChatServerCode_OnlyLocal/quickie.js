...
// --Chat system only working on local
//
...
//
// var exampleSocket = io.connect("localhost:3001");
// // var exampleSocket = io.connect("still-retreat-50906.herokuapp.com:3001");
//
...
//     var data = {
//         'messageText': $('#chatMessage')[0].value,
...
//     exampleSocket.emit('message',data);
//
// }
//
// exampleSocket.on('message', function(msg){
//    // alert(msg);
//    var item='\n' +
//        '<div class="container">\n' +
//        '\n'+msg.message +
//        '    <br/><p>'+msg.userName+'\t'+msg.userEmail+'</p>\n' +
//        '    <span class="time-right">'+msg.date+'</span>\n' +
//        '</div>';
//    $('#mainChat').append(item);
// });
